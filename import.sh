...
do
	...
	aws s3 mb s3://vm-import-images-epitech-tcloud901-vm11$i --region eu-west-$i
	aws s3 cp ./11$i.raw s3://vm-import-images-epitech-tcloud901-vm11$i/11$i.raw
	aws ec2 import-image --region eu-west-$i --description "Mariadb $i" --disk-containers "file://import/vm-11$i-import.json"
done
